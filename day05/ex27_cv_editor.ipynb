...
# 이미지 실시간 읽기
from tkinter import Tk, filedialog   # Tkinter 파이썬 기본 GUI 라이브러리
...
def update(_=None):
    ...
    threshold = cv2.getTrackbarPos('Threshold', winname)  # 이진화값 가져오기
...
cv2.createTrackbar('Threshold', winname, 0, 200, update)  # 이미지 이진화
