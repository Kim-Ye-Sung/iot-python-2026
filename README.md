...
14. 가상환경(Virtual Environment)
    ...
    - 가상환경은 github에 올리지 말 것. .gitignore에 가상환경 폴더 추가할 것
...
15. 객체지향 - [소스1](./day03/ex15_oop.py) ~ [소스4](./day03/ex18_encapsule.py)
    ...
    - public, private(__로 변수 선언), protected(_로 변수 선언). C++처럼 접근제한자를 많이 사용안함
...
- CSV
    - 엑셀과 호환가능한 텍스트파일
    - 텍스트 양이 많으면 한번에 읽을 수 없음. 한줄씩 나눠서 읽어야 함
    - 보통 csv 라이브러리 사용
...
- 기초 통계
    ...
    - 최빈값(Mode) - 가장 많이 나온값. WordlCloud에서 가장 많이 나온 값을 크게 표시
    - 분산(Variance) - 데이터가 얼마나 퍼져 있는지. 평균으로부터의 거리의 평균. 퍼진정도를 숫자로
...
#### 파이토치 기본문법
- [소스](./day7/ex29_pytorch_basic.ipynb)

#### 선형회귀(Linear Regression)
- [소스](./day7/ex30_pytorch_nn.ipynb)
...
- [소스](./day9/ex32_pytorch_fashion_mnist.ipynb)
...
- 설치방법
    ...
    ```bash
    > ./iot-venv/Scripts/Activae.ps1  # 가상환경 진입
...
- [소스](./day9/ex33_pytorch_cnn.ipynb)
